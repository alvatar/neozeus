use crate::{
    ...
    hud::{
        ...
        sync_hud_render_visibility_policy, sync_hud_view_models, sync_hud_widget_bloom,
        sync_info_bar_view_model, sync_structural_hud_layout,
    },
    input::{
...
pub(crate) fn configure_app_schedule(app: &mut App) {
    ...
    .add_systems(
        Update,
        (
            sync_hud_render_visibility_policy,
            render_hud_scene,
