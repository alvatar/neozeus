...
const BLOOM_COMPOSITE_ALPHA: f32 = 0.84;
...
fn bloom_source_color(focused: bool, hovered: bool, kind: AgentListBloomSourceKind) -> Color {
    match (focused, hovered, kind) {
        (true, _, AgentListBloomSourceKind::Accent) => Color::srgba(5.0, 0.26, 0.22, 0.48),
        (_, true, AgentListBloomSourceKind::Accent) => Color::srgba(3.2, 0.18, 0.15, 0.18),
        (_, _, AgentListBloomSourceKind::Accent) => Color::srgba(2.0, 0.14, 0.12, 0.08),
    }
}
